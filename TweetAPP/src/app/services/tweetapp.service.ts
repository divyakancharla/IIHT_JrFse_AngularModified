...
export class TweetappService {
  url:string='https://tweetapp.azurewebsites.net/api/v1.0/tweets/'
  constructor(private http:HttpClient) { }
  public Register(user:User):Observable<String>
  {   
     const headers = new HttpHeaders().set('Content-Type', 'application/json; charset=utf-8');
    return this.http.post<String>(this.url+'UserRegister',user, { headers, responseType: 'text' as 'json'})
  }
  public Login(username:string,password:string):Observable<any>
  {
   const headers = new HttpHeaders().set('Content-Type', 'application/json; charset=utf-8');
   return this.http.get<any>(this.url+'UserLogin/'+escape(username)+'/'+escape(password), { headers, responseType: 'json'})
  }
  public PostTweet(tweet:Tweet):Observable<String>
  {
   const headers = new HttpHeaders().set('Content-Type', 'application/json; charset=utf-8');
   return this.http.post<String>(this.url+'PostTweet',tweet,{​​​​​​​​ headers, responseType: 'text' as 'json'})
  }
  public GetAllUsers():Observable<any>
  {
    return this.http.get<any>(this.url+'UserTweets/all', Requestheaders)
  }
  public GetTweetsByUser(username:string):Observable<any>
  {
    return this.http.get<any>(this.url+'UserTweets/'+username, Requestheaders)
  }
  ...
  {​​​​​​​​    
    ...
    return this.http.put<String>(this.url+'resetpassword/'+escape(emailid)+'/'+escape(oldpassword)+'/'+escape(newpassword),{​​​​​​​​ headers, responseType: 'text'}​​​​​​​​)
  }​​​​​​​​
  ...
  {    
     return this.http.get<any>(this.url+'AllUserTweets/'+escape(username),Requestheaders)
  }
